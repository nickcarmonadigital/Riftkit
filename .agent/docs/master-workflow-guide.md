...
| File | Purpose |
|------|---------|
| `ai-onboarding-starter-template.md` | Single source of truth - onboards any AI to your project |
| `master-workflow-guide.md` | This file - explains how everything works |
...
└── .agent/
    ├── docs/
    │   ├── ai-onboarding-starter-template.md   ← YOUR PROJECT CONTEXT
    │   └── master-workflow-guide.md            ← HOW IT WORKS (this file)
    └── skills/
        ├── project_context/           ← Update after every change
        ├── new_project/               ← Starting fresh projects
        ├── feature_braindump/         ← Brain dump features
        ├── gemini_handoff/            ← Format for Gemini→Builder
        ├── bug_troubleshoot/          ← Fix broken things
        ├── claude_verification/       ← Code review
        └── documentation_framework/   ← Doc reference
```
