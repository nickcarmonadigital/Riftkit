...
2. Loads conversation history from `.agent/claw/{session}.md`
...
Sessions are stored as Markdown files in `.agent/claw/`:

```
.agent/claw/default.md
.agent/claw/my-project.md
```
