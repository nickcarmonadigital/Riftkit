...
| Phase | Codex | Gemini |
|-------|-------|--------|
| Analysis | `.agent/.ccg/prompts/codex/analyzer.md` | `.agent/.ccg/prompts/gemini/analyzer.md` |
| Planning | `.agent/.ccg/prompts/codex/architect.md` | `.agent/.ccg/prompts/gemini/architect.md` |
