...
**Path**: `.agent/docs/[feature-name]-architecture.md`
...
[ASCII diagram showing the user flow through this feature]
...
[ASCII diagram or step-by-step explanation]
...
1. **Use ASCII diagrams** - Visual flows are easier to understand than paragraphs
...
- [ ] Saved to `.agent/docs/[feature]-architecture.md`
- [ ] Committed to git
...
The following architecture documents exist in this project:

| Document | Feature |
|----------|---------|
| `onboarding-context-layer-architecture.md` | Strategic Onboarding & Context Layers |
| `rlm-integration-guide.md` | RLM (Recursive Language Models) for unbounded context |

Use these as reference when creating new architecture documentation.
