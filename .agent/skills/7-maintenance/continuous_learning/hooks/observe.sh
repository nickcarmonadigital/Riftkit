...
#
# Hook config (in .agent/settings.json):
#
...
#     "PreToolUse": [{
#       "matcher": "*",
#       "hooks": [{ "type": "command", "command": ".agent/skills/continuous-learning-v2/hooks/observe.sh pre" }]
#     }],
#     "PostToolUse": [{
#       "matcher": "*",
#       "hooks": [{ "type": "command", "command": ".agent/skills/continuous-learning-v2/hooks/observe.sh post" }]
#     }]
#   }
# }
