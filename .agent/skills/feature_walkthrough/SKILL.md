...
**Path**: `.agent/docs/walkthroughs/[feature-name]-walkthrough.md`
...
- [ ] Saved to `.agent/docs/walkthroughs/`
...
| `project_context` | Add walkthrough link to project context after creating |
| `documentation_framework` | Walkthrough is the "Post-Feature" documentation |
| `gemini_handoff` | Gemini spec → Implementation → Walkthrough |
